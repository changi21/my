...
# 주말 탭 기본 목록 (가족 시간 추가 및 13~18시, 19~21시 시간대 수정)
DEFAULT_WEEKEND = {
    "토요일": [
        ("06:30 ~ 07:00", "기상 및 아침 뇌 깨우기", "6시 30분~7시 사이 기상"),
        ("07:00 ~ 08:30", "📝 [주말 모닝 학습] 90분 몰입 완주", "수학+영어+독서"),
        ("08:30 ~ 09:00", "🍚 아침 식사 및 정돈", "온 가족 아침 식사"),
        ("10:00 ~ 12:00", "🎮 게임 & 자유시간 (120분)", "학습 완주 후 자유시간"),
        ("13:00 ~ 18:00", "⚾ [야외활동 & 외출] 신체활동 및 주말 외출", "햇빛 쬐며 야외 운동 및 가족 외출"),
        ("19:00 ~ 20:00", "🎲 [가족 시간] 보드게임 & 온 가족 대화", "온 가족 소통 및 즐거운 보드게임"),
        ("20:00 ~ 21:00", "📖 밤 몰입 독서 1시간", "차분하게 생각 키우기 독서"),
    ...
    "일요일": [
        ...
        ("10:00 ~ 12:00", "🎮 게임 & 자유시간 (120분)", "자유시간"),
        ("13:00 ~ 18:00", "⚾ [야외활동 & 외출] 신체활동 및 주말 외출", "야외 신체활동 및 주말 외출"),
...
with tab1:
    ...
    # 4단계 타임라인: 주말 탭에서 수정한 내용이 대시보드 카드에도 동적으로 연동되도록 반영
    with st.container(border=True):
        st.markdown(
            f"""
