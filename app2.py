...
# 2. Tailwind CSS 기반 Pretendard 모던 스타일링 (박스 겹침 수정)
st.markdown(
    """
<style>
...
# ==========================================
# TAB 1: 대시보드 (뱃지 제거 및 타임라인 박스 겹침 완전 해결)
# ==========================================
with tab1:
    # 📌 요청사항 1 적용: 우측 연속미션 완료 뱃지 삭제
    st.markdown(
        """
    ...
    with c1:
        st.markdown(
            ...
            <div class="custom-card-box">
                ...
                <div style="font-size:11px; color:#64748b; margin-top:2px; margin-bottom:8px;">학업, 수면, 휴식, 이동의 균형 시각화</div>
            """,
            unsafe_allow_html=True,
        )
    ...
    with c2:
        st.markdown(
            ...
            <div class="custom-card-box">
                ...
                <div style="font-size:11px; color:#64748b; margin-top:2px; margin-bottom:8px;">15~30분 단위 숏 스퍼트로 지루함 없는 구성</div>
            """,
            unsafe_allow_html=True,
        )
        df_bar = pd.DataFrame({
        ...
        fig_bar = px.bar(
            ...
            color="과목",
            text="시간(분)",
            color_discrete_sequence=["#3b82f6", "#8b5cf6", "#ec4899", "#64748b"],
        )
    ...
    # 📌 요청사항 2 적용: 타임라인 큰 상자와 내부 작은 상자 중첩 완전 해결
    st.markdown(
        """
        <div class="custom-card-box">
...
# ==========================================
# TAB 5: 체크 & 기록 (📌 요청사항 3 적용: 7일간 누적 실천 로그 기능 구현)
# ==========================================
with tab5:
    st.markdown(
        """
    ...
    if edit_chk:
        ...
        st.markdown(
            f"""
            <div class="custom-card-box" style="text-align:center;">
